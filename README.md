...
<table><tr>
<td align="center"><b>📦 Domains tracked</b><br/><sub><code>9,536</code></sub></td>
<td align="center"><b>💰 Est. revenue</b><br/><sub><code>$80,029</code></sub></td>
<td align="center"><b>📡 Deployed</b><br/><sub><code>66.4%</code></sub></td>
<td align="center"><b>✅ Confirmed phishing</b><br/><sub><code>35.8%</code> (3,418)</sub></td>
<td align="center"><b>⚡ Fresh (≤7d)</b><br/><sub><code>6.7%</code></sub></td>
...
`login (44)` &middot; `binance (35)` &middot; `ledger (31)` &middot; `secure (30)` &middot; `trust (29)` &middot; `support (28)` &middot; `official (27)` &middot; `crypto (23)` &middot; `vault (22)` &middot; `coinbase (22)` &middot; `connect (21)` &middot; `wallet (17)` &middot; `verify (16)` &middot; `bridge (13)` &middot; `account (13)`
